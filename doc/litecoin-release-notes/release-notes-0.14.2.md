PricecoinX Core version 0.14.2 is now available from:
  ...
  <https://download.pricecoincrypto.com/pricecoinx-0.14.2.0/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/ZachChan105/pricecoinx/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/ZachChan105/pricecoinx/blob/master/doc/zmq.md) for
